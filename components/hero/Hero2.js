    ...
    >
      ...
      >
        <div className="mb-6 lg:col-span-5 lg:col-start-2 lg:mb-24">
          <div className="flex h-full flex-col items-start justify-end">
            <Image
              ...
              className="mb-8"
            />
            <h1 className="title font-primary text-4xl uppercase tracking-[-0.1875rem] text-typo-primary lg:text-5xl xl:text-[59px]">
              {title}
            </h1>
          </div>
        </div>
        ...
        <div className="mb-10 lg:col-span-4 lg:col-start-8 lg:mb-24">
          <div className="flex h-full flex-col items-start justify-end">
            <p
              className="paragraph mb-11 text-start font-secondary text-2xl font-normal text-typo-secondary drop-shadow-[0px_2px_1.3px_#00000033]"
              id="hero"
            >
              {text}
            </p>
